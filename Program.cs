...
class Ali
{
    public static void Main()
    {
        ...
        while (continueSearching)
        {
            ...
            List<Costumer> customers = LC.FindAll(C => C.ID.ToString() == choice || C.Name.ToUpper().Contains(choice) || C.Gender.ToUpper() == choice || C.Salary.ToString() == choice);  // Using Lambda Expression
